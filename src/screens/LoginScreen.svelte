...
<div class="flex flex-col items-center justify-center h-full min-h-[80vh] px-4">
    <Card class="w-full max-w-sm text-center">
        <div class="flex flex-col items-center py-6 space-y-6">
            ...
            <div class="space-y-2">
                <h1 class="text-2xl font-bold text-gray-100">Money Tracker</h1>
                <p class="text-sm text-gray-400">Track your expenses easily</p>
            </div>
