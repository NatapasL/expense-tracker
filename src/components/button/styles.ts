...
export const styles = {
	base: 'inline-flex justify-center items-center px-4 py-2 text-sm font-medium rounded transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-discord-bg disabled:opacity-50 disabled:cursor-not-allowed',
	variant: {
